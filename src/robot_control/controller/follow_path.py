...
class FollowPathController(Controller):
    ...
    def __init__(
        ...
        # Size baseline
        self._car_size = effective_robot_size_cm(config.car_width, config.car_height)
    ...
    def set_path(self, path: List[Point]) -> None:
        ...
        self._car_size = effective_robot_size_cm(self._config.car_width, self._config.car_height)
